...
export function getContract_FraxlendMarket(address) {
    const contract = new web3HttpProvider.eth.Contract(getABI_FraxlendMarket(), address);
    return contract;
}
export function getABI_FraxlendMarket() {
    const abi = [
        {
            inputs: [
...
//# sourceMappingURL=FraxlendMarket.js.map