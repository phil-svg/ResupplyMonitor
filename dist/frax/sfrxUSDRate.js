...
*/
export async function getsfrxUSDRate(blockNumber) {
    try {
        ...
        const maxDistributionPerSecondPerAsset = Number(await web3Call(contract_sFRAX, 'maxDistributionPerSecondPerAsset', [], blockNumber));
...
//# sourceMappingURL=sfrxUSDRate.js.map