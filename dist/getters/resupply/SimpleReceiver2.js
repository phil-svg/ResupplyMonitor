...
export const address_SimpleReceiver2 = '0xC9a9C21F8740684129d271Ad1007E87E24858c59';
export function getContract_SimpleReceiver2() {
    const contract = new web3HttpProvider.eth.Contract(getABI_SimpleReceiver2(), address_SimpleReceiver2);
    return contract;
}
export function getABI_SimpleReceiver2() {
    const abi = [
        {
            inputs: [
...
//# sourceMappingURL=SimpleReceiver2.js.map