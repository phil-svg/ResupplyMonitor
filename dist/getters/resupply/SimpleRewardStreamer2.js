...
export const address_SimpleRewardStreamer2 = '0xB96699a960A2b6300889b4FB789A58B506F144Ca';
export function getContract_SimpleRewardStreamer2() {
    const contract = new web3HttpProvider.eth.Contract(getABI_SimpleRewardStreamer2(), address_SimpleRewardStreamer2);
    return contract;
}
export function getABI_SimpleRewardStreamer2() {
    const abi = [
        {
            inputs: [
...
//# sourceMappingURL=SimpleRewardStreamer2.js.map