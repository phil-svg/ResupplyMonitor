...
export const address_reUSD = '0x57aB1E0003F623289CD798B1824Be09a793e4Bec';
export function getContract_reUSD() {
    const contract = new web3HttpProvider.eth.Contract(getABI_reUSD(), address_reUSD);
    return contract;
}
export function getABI_reUSD() {
    const abi = [
        {
            inputs: [
