...
export const address_reusdscrv_gauge = '0xaF01d68714E7eA67f43f08b5947e367126B889b1';
export function getContract_reusdscrv_gauge() {
    const contract = new web3HttpProvider.eth.Contract(getABI_reusdscrv_gauge(), address_reusdscrv_gauge);
    return contract;
}
export function getABI_reusdscrv_gauge() {
    const abi = [
        {
            name: 'Deposit',
            inputs: [
        ...
        },
        {
            ...
            inputs: [{ name: '_gauge_manager', type: 'address', indexed: false }],
            anonymous: false,
            type: 'event',
        },
        {
        ...
        },
        {
            ...
            inputs: [{ name: '_gauge_manager', type: 'address' }],
            outputs: [],
        },
        {
            stateMutability: 'nonpayable',
