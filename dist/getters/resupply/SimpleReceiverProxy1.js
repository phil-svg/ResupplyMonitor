...
export const address_SimpleReceiverProxy1 = '0x70a1879aEeA28072E321d52427f0aC88603dF61b';
export function getContract_SimpleReceiverProxy1() {
    const contract = new web3HttpProvider.eth.Contract(getABI_SimpleReceiver1(), address_SimpleReceiverProxy1);
    return contract;
}
export function getABI_SimpleReceiver1() {
    const abi = [
        {
            inputs: [
...
//# sourceMappingURL=SimpleReceiverProxy1.js.map