...
export const address_PermaStaker1 = '0xCCCCCccc94bFeCDd365b4Ee6B86108fC91848901';
export function getContract_PermaStaker1() {
    const contract = new web3HttpProvider.eth.Contract(getABI_PermaStaker1(), address_PermaStaker1);
    return contract;
}
export function getABI_PermaStaker1() {
    const abi = [
        {
            inputs: [
...
//# sourceMappingURL=PermaStaker1%20copy.js.map