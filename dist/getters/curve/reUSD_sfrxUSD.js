...
export const address_reUSD_sfrxUSD = '0xed785Af60bEd688baa8990cD5c4166221599A441';
export function getContract_reUSD_sfrxUSD() {
    const contract = new web3HttpProvider.eth.Contract(getABI_reUSD_sfrxUSD(), address_reUSD_sfrxUSD);
    return contract;
}
export function getABI_reUSD_sfrxUSD() {
    const abi = [
        {
            name: 'Transfer',
            inputs: [
