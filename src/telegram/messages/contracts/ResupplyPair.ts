...
function getRewardToken(tokenAddress: string) {
...
async function getResupplyPairAggregatedInfo(
  event: any,
  pairAddress: string,
  pairName: string,
...
async function convertSharesToAmount(event: any, name: string, contractAddress: string, sharesAmount: number) {
  if (name.includes('CurveLend')) {
...
export async function getMessage_ResupplyPair_RewardPaid(
  event: any,
  pairAddress: string,
  pairName: string
): Promise<string | null> {
...
export async function getMessage_ResupplyPair_AddCollateral(
  event: any,
  pairAddress: string,
  pairName: string,
  collateralAddress: string
...
export async function getMessage_ResupplyPair_Borrow(
  event: any,
  pairAddress: string,
  pairName: string,
  collateralAddress: string
...
export async function getMessage_ResupplyPair_LeveragedPosition(
  event: any,
  pairAddress: string,
  pairName: string
): Promise<string | null> {
...
export async function getMessage_ResupplyPair_RemoveCollateral(
  event: any,
  pairAddress: string,
  pairName: string,
  collateralAddress: string
...
export async function getMessage_ResupplyPair_Repay(
  event: any,
  pairAddress: string,
  pairName: string,
  collateralAddress: string
...
export async function getMessage_ResupplyPair_Redeemed(
  event: any,
  pairAddress: string,
  pairName: string,
  collateralAddress: string
  ...
  const collateralAmount = await convertSharesToAmount(
    ...
    pairName,
    collateralAddress,
    event.returnValues._collateralFreed / 1e18
  );
...
🔓${await getUser(event.returnValues._caller)} redeemed ${formatForPrint(
    event.returnValues._amount / 1e18
