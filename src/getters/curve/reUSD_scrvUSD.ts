...
export const address_reUSD_scrvUSD = '0xc522A6606BBA746d7960404F22a3DB936B6F4F50';

export function getContract_reUSD_scrvUSD() {
  const contract = new web3HttpProvider.eth.Contract(getABI_reUSD_scrvUSD(), address_reUSD_scrvUSD);
  return contract;
}

export function getABI_reUSD_scrvUSD(): any {
  const abi = [
    {
      name: 'Transfer',
      inputs: [
