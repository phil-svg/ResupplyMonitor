...
export const address_RSUP = '0x419905009e4656fdC02418C7Df35B1E61Ed5F726';

export function getContract_RSUP() {
  const contract = new web3HttpProvider.eth.Contract(getABI_RSUP(), address_RSUP);
  return contract;
}

export function getABI_RSUP(): any {
  const abi = [
    {
      inputs: [
    ...
    { anonymous: false, inputs: [], name: 'FinalizeMinter', type: 'event' },
    {
      anonymous: false,
    ...
    { inputs: [], name: 'finalizeMinter', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    {
      inputs: [],
      name: 'globalSupply',
      outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
