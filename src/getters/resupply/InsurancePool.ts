...
export const address_InsurancePool = '0x00000000efe883b3304aFf71eaCf72Dbc3e1b577';

export function getContract_InsurancePool() {
  const contract = new web3HttpProvider.eth.Contract(getABI_InsurancePool(), address_InsurancePool);
  return contract;
}

export function getABI_InsurancePool(): any {
  const abi = [
    {
      inputs: [
        ...
        { internalType: 'address', name: '_emissionsReceiver', type: 'address' },
      ],
    ...
    {
      anonymous: false,
      inputs: [{ indexed: false, internalType: 'uint256', name: 'minimumAssets', type: 'uint256' }],
      name: 'MinimumHeldAssetsUpdated',
      type: 'event',
    },
    {
      anonymous: false,
    ...
    },
    {
      ...
      inputs: [
        ...
        { indexed: false, internalType: 'uint256', name: 'withdrawWindow', type: 'uint256' },
      ],
      name: 'WithdrawTimersUpdated',
      type: 'event',
    },
    {
      inputs: [],
    ...
    },
    {
      ...
      name: 'balanceOf',
      outputs: [{ internalType: 'uint256', name: 'userBalance', type: 'uint256' }],
      stateMutability: 'view',
      type: 'function',
    },
    {
    ...
    { inputs: [], name: 'cancelExit', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    {
      inputs: [
    ...
    {
      inputs: [
        { internalType: 'uint256', name: '_withdrawLength', type: 'uint256' },
        { internalType: 'uint256', name: '_withdrawWindow', type: 'uint256' },
      ],
      name: 'setWithdrawTimers',
      outputs: [],
      stateMutability: 'nonpayable',
      type: 'function',
    },
