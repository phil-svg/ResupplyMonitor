...
export const address_reusdsfrx_gauge = '0x5C0B03914f68F2717d779a0211fd98C2CC45a4dD';

export function getContract_reusdsfrx_gauge() {
  const contract = new web3HttpProvider.eth.Contract(getABI_reusdsfrx_gauge(), address_reusdsfrx_gauge);
  return contract;
}

export function getABI_reusdsfrx_gauge(): any {
  const abi = [
    {
      name: 'Deposit',
      inputs: [
