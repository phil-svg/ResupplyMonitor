...
export const address_reusdsfrx = '0xed785Af60bEd688baa8990cD5c4166221599A441';

export function getContract_reusdsfrx() {
  const contract = new web3HttpProvider.eth.Contract(getABI_reusdsfrx(), address_reusdsfrx);
  return contract;
}

export function getABI_reusdsfrx(): any {
  const abi = [
    {
      name: 'Transfer',
      inputs: [
