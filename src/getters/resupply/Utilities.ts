...
export const address_Utilities = '0x38EaD0a5448FAcdCadFE72BEda766E8cd8371074';

export function getContract_Utilities() {
  const contract = new web3HttpProvider.eth.Contract(getABI_Utilities(), address_Utilities);
  return contract;
}

export function getABI_Utilities(): any {
  const abi = [
    {
