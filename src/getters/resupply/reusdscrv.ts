...
export const address_reusdscrv = '0xc522A6606BBA746d7960404F22a3DB936B6F4F50';

export function getContract_reusdscrv() {
  const contract = new web3HttpProvider.eth.Contract(getABI_reusdscrv(), address_reusdscrv);
  return contract;
}

export function getABI_reusdscrv(): any {
  const abi = [
    {
      name: 'Transfer',
      inputs: [
