...
import {
  getMessage_reUSD_scrvUSD_AddLiquidity,
  getMessage_reUSD_scrvUSD_RemoveLiquidity,
  getMessage_reUSD_scrvUSD_RemoveLiquidityOne,
} from '../../../telegram/messages/contracts/reUSD_scrvUSD.js';
import { fetchEventsRealTime, registerHandler } from '../../../web3/AllEvents.js';

export async function plugTo_reUSD_scrvUSD(eventEmitter: any) {
